...
public class AccessSQLUtil {
	...
	public static String createRecordInsert(JournalEntry jEntry, String tableName) {
		...
		if(jEntry.getId().length() > 0)
		{
			...
			insertStatement.append("[Subject], ");
			insertStatement.append("[Author], ");
			insertStatement.append("[Quote From], ");
			insertStatement.append("[Source], ");
			insertStatement.append("[Scripture], ");
			insertStatement.append("[Memo], ");
			insertStatement.append("[Special], ");
			insertStatement.append("[Date], ");
			insertStatement.append("[MessageText], ");
			insertStatement.append("[Location])");
